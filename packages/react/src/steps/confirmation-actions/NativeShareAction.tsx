...
export function NativeShareAction({ config, fallbackTitle, answers }: NativeShareActionProps) {
  function share() {
    ...
    navigator
      .share({ title: config.shareTitle ?? fallbackTitle, text: answersToText(answers) })
      .catch(() => {})
  }
