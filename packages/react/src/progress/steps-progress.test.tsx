...
describe("StepsProgress", () => {
  it("renders a numbered circle per step, no title text", () => {
  ...
  it("handles many steps and long titles without throwing (titles never rendered)", () => {
  ...
  it("renders steps with no title without a valuetext", () => {
    const { container } = render(
