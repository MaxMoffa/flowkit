...
export interface ThemeLayoutTokens {
  ...
  /** Progress bar variant: solid bar, dots, numbered stepper, segmented bar, hidden, or
   *  the key of a registered custom component. Default: "bar". */
  progressVariant?: "bar" | "dots" | "steps" | "segments" | "hidden" | string
