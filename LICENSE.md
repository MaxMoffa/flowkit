...
Required Notice: Copyright © 2026 Massimo Moffa — <https://github.com/MaxMoffa/flowkit>

Licensor Line of Business: Flowlab — a hosted, multi-tenant, no-code platform for
visually creating, publishing, hosting, filling, collecting, and exporting guided
multi-step flows, forms, and surveys (<https://github.com/MaxMoffa/flowlab>)

---

**Scope (not part of the license text below).** This license applies to **FlowKit
version 1.0.0 and later** — the packages `@flowkit-io/core`, `@flowkit-io/react`,
`@flowkit-io/themes`, `@flowkit-io/adapters`, `@flowkit-io/presets`, and
`@flowkit-io/create-flowkit` at `1.0.0` or above, and the source in this repository from
`1.0.0` onward. FlowKit releases **before 1.0.0** (the `0.x` series) were published under
the **MIT License** and remain available under those terms; that grant is not revoked.
For a plain-language explanation see [`LICENSING.md`](./LICENSING.md); for a commercial
(competing-use) license see [`COMMERCIAL-LICENSE.md`](./COMMERCIAL-LICENSE.md).

What follows is the verbatim text of the PolyForm Shield License 1.0.0.
