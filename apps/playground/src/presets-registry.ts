...
const presetLoaders: Record<string, () => Promise<Flow>> = {
  ...
  "catalog-demo": () => import("./catalog-demo").then((m) => m.catalogDemoFlow),
  "product-demo": () => import("./product-demo").then((m) => m.productDemoFlow),
  ...
  "camera-demo": () => import("./camera-demo").then((m) => m.cameraDemoFlow),
  ...
  "content-text-demo": () => import("./content-text-demo").then((m) => m.contentTextDemoFlow),
...
export const presetLabels: Record<string, string> = {
  ...
  "catalog-demo": "Carrello + pagamento (demo)",
  "product-demo": "Vetrina prodotto, 1-4 articoli (demo)",
  ...
  "camera-demo": "Foto + scansione codice (demo)",
  ...
  "content-text-demo": "Contenuto localizzabile via flow.content (demo)",
